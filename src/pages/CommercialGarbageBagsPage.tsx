...
const INDUSTRIES = [
  {
    ...
    description:
      'Reliable waste management for kitchens and food preparation areas.',
  },
  {
    title: 'Healthcare Facilities',
    description:
      'Safe and hygienic waste disposal solutions for hospitals and clinics.',
  },
  {
    title: 'Hotels & Hospitality',
    description: 'Supports housekeeping operations with durable trash liners.',
  },
  {
    title: 'Cleaning & Facility Management',
    description:
      'Trusted by professional cleaning companies handling large-scale waste collection.',
  },
];
...
const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: 'Restaurants, healthcare, hospitality, cleaning companies, warehouses, and more.',
  },
  {
    id: 'faq-5',
    q: 'Do you offer private label garbage bags?',
    a: 'Yes — custom branding, logo printing and private label packaging are available based on MOQ.',
  },
];
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-[#dfe7f8] py-20 md:py-22 lg:py-22">
          <img
            ...
            width={384}
            height={384}
            className="pointer-events-none absolute -left-12 bottom-0 hidden w-72 select-none opacity-80 lg:block lg:w-96"
          />
          <img
            ...
            width={384}
            height={384}
            className="pointer-events-none absolute right-0 top-0 hidden w-72 select-none opacity-90 lg:block lg:w-96"
          />
          ...
          <div className="mx-auto flex flex-col items-center gap-16 px-4 lg:grid lg:grid-cols-2 md:px-16 lg:px-16">
            ...
            <div className="relative order-1 mx-auto flex w-full max-w-[580px] items-center justify-center lg:order-2 lg:mx-0 lg:justify-end">
              ...
              <div className="absolute inset-0 z-0 flex items-center justify-center">
                <img
                  ...
                  width={500}
                  height={500}
                  className="w-full max-w-[500px] select-none opacity-90 lg:hidden"
                />
            ...
            <div className="relative z-10 order-2 flex flex-col items-center text-center lg:order-1 lg:items-start lg:text-left">
              ...
              <p className="mt-8 max-w-xl text-lg font-small leading-relaxed text-slate-600 lg:text-md">
                Durable HDPE &amp; LLDPE trash can liners designed for
                commercial waste management, industrial use, and large-scale
                operations.
              </p>
              <div className="mt-10 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
                <a
                  href="#specifications"
                  className="inline-flex h-11 items-center justify-center rounded-full border border-slate-300 bg-white px-6 text-base font-bold text-slate-700 transition hover:bg-slate-50 active:scale-95 sm:px-8"
                  onClick={(e) => {
                    e.preventDefault();
                ...
                <a
                  href="#contact"
                  className="inline-flex h-11 items-center justify-center rounded-full bg-black px-6 text-base font-bold !text-white shadow-lg transition hover:bg-slate-800 hover:-translate-y-1 active:scale-95 sm:px-8"
                  onClick={(e) => {
                    e.preventDefault();
          ...
          <div className="mx-auto grid items-center gap-16 px-4 lg:grid-cols-3 lg:px-16">
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
              <h2 className="text-4xl font-black leading-[1.05] tracking-tight text-slate-900 sm:text-5xl lg:text-[5rem] lg:leading-[0.95]">
                Key
                <br className="hidden lg:block" /> Features
              </h2>
              <p className="mt-8 text-lg font-medium leading-relaxed text-slate-500 lg:text-xl">
                Heavy-duty HDPE &amp; LLDPE garbage bags designed for maximum
                strength and reliable protection.
              </p>
            ...
            <div className="flex flex-col gap-8 lg:pl-12">
              {FEATURES.map((line, i) => (
                <div
                  key={i}
                  className="flex flex-col items-center text-center gap-6 border-b border-slate-300/50 pb-8 last:border-0 sm:flex-row sm:items-start sm:text-left"
                >
