            ...
            <div className="lg:col-span-1 flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <div className="mt-6 border-t border-white/10 pt-6 w-full">
                <p className="text-[13px] leading-relaxed text-slate-400">
                  Providing high-quality, durable, and eco-conscious packaging
                  solutions for businesses of all sizes. Trusted by Industries
                  nationwide.
                </p>
              </div>
            </div>
            ...
            <div className="sm:col-span-2 md:col-span-3 lg:col-span-2 xl:col-span-2 mt-8 md:mt-0">
              <div className="grid gap-y-12 gap-x-10 sm:grid-cols-2">
                ...
                <div className="flex gap-4 order-1">
                  ...
                  <div>
                    <h4 className="font-montserrat text-lg font-bold leading-tight">
                      New Jersey Location
                    </h4>
                ...
                <div className="flex gap-4 order-3 sm:order-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3 text-[13px]">
                      ...
                      >
                        <img src={CallingIcon} alt="" className="h-4 w-4" />{' '}
                        (914) 703-2250
                      </a>
                      <a
                        href="mailto:jay@kavimports.com"
                ...
                <div className="flex gap-4 order-4 sm:order-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3 text-[13px]">
                      ...
                      <a
                        href="mailto:kanak@kavimports.com"
                        className="flex items-center gap-2 text-blue-400 hover:underline transition"
                      >
                        <img src={MailIcon} alt="" className="h-4 w-4" />{' '}
                        kanak@kavimports.com
                      </a>
                      <a
                        href="mailto:texas@kavimports.com"
                        className="flex items-center gap-2 text-blue-400 hover:underline transition"
                      >
                        <img src={MailIcon} alt="" className="h-4 w-4" />{' '}
                        texas@kavimports.com
                      </a>
                    </div>
                  </div>
                </div>
